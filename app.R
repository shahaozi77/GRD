...
ui <- fluidPage(
  navbarPage("GRD",
             tabPanel("Home",
                      mainPanel(
                        ...
                        p("GRD is a web server to obtain gene related drugs in CTRP database, which includes drug-response data along with response profiles for 481 compounds in 860 cell lines, as well as RNA-seq data. There are three types of analyses in GRD. To start an analysis, Users should first submit an interested gene to 'Gene Related Drugs' module, this will allows users to visualize the association between the expression of submitted gene and drug response by volcano plot.", style = "font-family: 'times'; font-si22pt",align="justify"),
                        img(src='volcano.jpg',height="50%",width="70%",style="display: block; margin-left: auto; margin-right: auto;"),
                        br(),
                        br(),
                         p("'Expression' could then display the expression level for the submitted gene across all tumor cell lines in CTRP database. Distribution of the gene expression levels are displayed by box plot. All the gene expression values are log2 transformed.", style = "font-family: 'times'; font-si22pt",align="justify"),
                        img(src='page.png',height="75%",position="absolute", width="100%"),
                        br(),
                        br(),
                         p("In 'Fraction' page, users could visualize the proportion of responsive drugs by calculating the ratio of drugs with absolute correlation coefficient greater than 0.3 and p value less than 0.05 in different cell lines, and defined as resistant group (correlation coefficients >0.3) and sensitive group (correlation coefficients< -0.3), respectively. Pyramid plot was then utilized to visualize the ratio distribution of related drugs between these two groups.", style = "font-family: 'times'; font-si22pt",align="justify"),
                      ...
                      sidebarLayout(
                        ...
                        mainPanel(
                          ...
                          h3("Introduction",align="left",
                             style ="font-family: 'times'; font-size: 24pt "),
                          p("To start an analysis, Users should first submit an interested gene to 'Gene Related Drugs' module, this will allows users to visualize the association between the expression of submitted gene and drug response by volcano plot.Users could change correlation coefficient and pvalue to get the personalized plot. please", span("submit again everytime you change the parameters", style = "color:blue"),"to generate the plot.",
 ...
 tabPanel("Expression",
          mainPanel(
            h3("Introduction",align="left",
               style ="font-family: 'times'; font-size: 24pt "),
            p("'Expression' allows users to visualize the differential expression for the submitted gene across all tumor cell lines in CTRP database. Distributions of mRNA gene expression levels are displayed by box plot. All the gene expression values are log2 transformed. Users could get general idea about the distribution for a given gene in different cancer cell lines.",
               style = "font-family: 'times'; font-si22pt",align="justify"),
            div(),
            plotOutput("summary2"),
            br(),
